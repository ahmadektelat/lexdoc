...
export const ar: Record<string, string> = {
  ...
  // Messaging module
  'messaging.title': 'التواصل مع العملاء',
  'messaging.subtitle': 'إرسال الرسائل والجدولة وإدارة القوالب',
  'messaging.tabSend': 'إرسال',
  'messaging.tabSchedule': 'جدولة',
  'messaging.tabHistory': 'السجل',
  'messaging.tabTemplates': 'القوالب',
  'messaging.selectTemplate': 'اختر قالب رسالة',
  'messaging.selectClients': 'اختر العملاء',
  'messaging.selectAll': 'تحديد الكل',
  'messaging.clearAll': 'مسح الكل',
  'messaging.preview': 'معاينة',
  'messaging.previewTitle': 'معاينة',
  'messaging.send': 'إرسال',
  'messaging.sendCount': 'إرسال {{count}} رسائل',
  'messaging.sendSuccess': 'تم إرسال الرسائل بنجاح',
  'messaging.period': 'الفترة',
  'messaging.dueDate': 'تاريخ الاستحقاق',
  'messaging.taskDue': 'الموعد النهائي للتسليم',
  'messaging.subject': 'الموضوع',
  'messaging.body': 'محتوى الرسالة',
  'messaging.channel': 'قناة الإرسال',
  'messaging.channelEmail': 'بريد إلكتروني',
  'messaging.channelSms': 'رسالة نصية',
  'messaging.channelWhatsapp': 'واتساب',
  'messaging.scheduleDate': 'تاريخ الإرسال',
  'messaging.scheduleAdd': 'جدولة رسالة',
  'messaging.scheduleSuccess': 'تمت جدولة الرسالة بنجاح',
  'messaging.schedulePending': 'قيد الانتظار',
  'messaging.runNow': 'تشغيل الرسائل المعلقة',
  'messaging.runResult': 'تم إرسال {{count}} رسائل',
  'messaging.cancelScheduled': 'إلغاء',
  'messaging.cancelSuccess': 'تم إلغاء الرسالة المجدولة',
  'messaging.noScheduled': 'لا توجد رسائل مجدولة',
  'messaging.noMessages': 'لا توجد رسائل في السجل',
  'messaging.filterClient': 'جميع العملاء',
  'messaging.filterTopic': 'جميع المواضيع',
  'messaging.templateEdit': 'تعديل',
  'messaging.templateSave': 'حفظ القالب',
  'messaging.templateSaved': 'تم تحديث القالب',
  'messaging.templateCreate': 'قالب جديد',
  'messaging.templateDelete': 'حذف القالب',
  'messaging.templateVarsHint': 'المتغيرات المتاحة',
  'messaging.templateName': 'اسم القالب',
  'messaging.templateBody': 'محتوى القالب',
  'messaging.templateColor': 'اللون',
  'messaging.templateIcon': 'الأيقونة',
  'messaging.templateDefault': 'افتراضي',
  'messaging.confirmDelete': 'هل تريد حذف هذا القالب؟',
  'messaging.deleteSuccess': 'تم حذف القالب',
  'messaging.noEmail': 'لا يوجد بريد إلكتروني',
  'messaging.noClients': 'لا يوجد عملاء نشطون',
  'messaging.clientsSelected': '{{count}} عملاء محددين',
  'messaging.viewDetail': 'عرض',
  'messaging.quickSend': 'إرسال رسالة',
  'messaging.statusSent': 'تم الإرسال',
  'messaging.statusFailed': 'فشل',
  'messaging.statusPending': 'قيد الانتظار',
  'messaging.statusCancelled': 'ملغى',
  'messaging.variableHint': 'أدخل قيمة لـ {{var}}',
  'messaging.templateTopicId': 'معرف الموضوع',
  'messaging.varClientName': 'اسم العميل',
  'messaging.varStaffName': 'اسم الموظف',
  'messaging.varFirmName': 'اسم المكتب',
  'messaging.varPeriod': 'الفترة',
  'messaging.varDueDate': 'تاريخ الاستحقاق',
  'messaging.varTaskDue': 'الموعد النهائي للتسليم',
  'messaging.varAmount': 'المبلغ',
  'messaging.varToday': 'تاريخ اليوم',
  'messaging.varPhone': 'هاتف العميل',
  ...
  'backup.description': 'نسخ احتياطي، استعادة، استيراد وتصدير بيانات المكتب',
  'backup.downloadBackup': 'تحميل نسخة احتياطية (.BAK)',
  'backup.creating': 'جاري إنشاء النسخة...',
  'backup.estimatedSize': 'الحجم التقريبي',
  'backup.clientCount': 'عملاء',
  'backup.staffCount': 'موظفين',
  'backup.backupData': 'نسخ احتياطي للبيانات',
  'backup.backupDesc': 'إنشاء ملف .BAK يحتوي على جميع البيانات: عملاء، ساعات، فواتير، تقديمات',
  'backup.restore': 'استعادة البيانات',
  'backup.restoreDesc': 'تحميل ملف .BAK لاستعادة البيانات. البيانات الموجودة ستدمج مع النسخة الاحتياطية',
  'backup.restoreWarning': 'تنبيه: الاستعادة ستدمج البيانات. يُنصح بأخذ نسخة احتياطية قبل الاستعادة.',
  'backup.loadFile': 'تحميل ملف نسخة احتياطية (.BAK)',
  'backup.restoring': 'جاري الاستعادة...',
  'backup.restoreSuccess': 'تمت الاستعادة بنجاح',
  'backup.restoreFailed': 'فشلت الاستعادة — ملف غير صالح أو إصدار قديم',
  'backup.fileError': 'خطأ في قراءة الملف',
  'backup.storageTitle': 'التخزين والحجم',
  'backup.hoursLogged': 'ساعات مسجلة',
  'backup.invoices': 'فواتير',
  'backup.records': 'سجلات',
  'backup.active': 'نشط',
  'backup.usageLabel': 'حجم الاستخدام',
  'backup.tabBackup': 'نسخ واستعادة',
  'backup.tabImport': 'استيراد',
  'backup.tabExport': 'تصدير',
  'backup.tabDocs': 'مستندات',
  'backup.downloaded': 'تم تحميل النسخة الاحتياطية',
  'backup.foreignFirmWarning': 'النسخة الاحتياطية تنتمي لمكتب آخر ({firmName}). سيتم استيراد البيانات إلى المكتب الحالي.',
  'backup.foreignFirmConfirm': 'أفهم — استيراد بيانات من مكتب آخر',
  'backup.piiWarningTitle': 'تحذير بيانات حساسة',
  'backup.piiWarningDesc': 'ملف النسخة الاحتياطية يحتوي على بيانات حساسة مثل أرقام الهوية والبيانات المالية والمعلومات الشخصية. يجب تخزين الملف في مكان آمن.',
  'backup.fileTooLarge': 'الملف كبير جداً. الحجم الأقصى هو {size}.',

  // Import
  'import.title': 'استيراد عملاء',
  'import.dragDrop': 'اسحب ملف Excel / CSV هنا',
  'import.clickSelect': 'أو انقر لاختيار ملف',
  'import.supported': 'مدعوم: CSV, Excel (XLSX/XLS), JSON',
  'import.instructions': 'تعليمات الاستيراد',
  'import.headerRow': 'الصف الأول: عناوين الأعمدة (بالعبرية / الإنجليزية)',
  'import.requiredField': 'حقل مطلوب: اسم العميل / الشركة',
  'import.taxIdFormat': 'رقم المشتغل: 9 أرقام (مشتغل مرخص / شركة)',
  'import.feeFormat': 'أتعاب: رقم بالشيكل (بدون علامة ₪)',
  'import.noDuplicates': 'العملاء الموجودون (نفس الاسم) لن يتم استيرادهم مرتين',
  'import.downloadTemplate': 'تحميل قالب CSV نموذجي',
  'import.preview': 'معاينة',
  'import.rows': 'صفوف',
  'import.errors': 'أخطاء',
  'import.importButton': 'استيراد {count} عملاء',
  'import.cancel': 'إلغاء',
  'import.done': 'تم الاستيراد!',
  'import.doneDesc': 'تم استيراد {count} عملاء جدد إلى النظام',
  'import.importMore': 'استيراد إضافي',
  'import.noData': 'لم يتم العثور على بيانات قابلة للقراءة في الملف',
  'import.missingName': 'اسم العميل مفقود',
  'import.invalidEmail': 'عنوان بريد إلكتروني غير صالح',
  'import.invalidPhone': 'رقم هاتف غير صالح',
  'import.invalidTaxId': 'رقم مشتغل غير صالح',
  'import.invalidFee': 'مبلغ أتعاب غير صالح',
  'import.duplicate': 'موجود',
  'import.supportedFields': 'الحقول المدعومة للاستيراد',
  'import.requiredIndicator': 'حقل مطلوب',
  'import.imported': 'تم استيراد {count} عملاء',

  // Export
  'export.title': 'تصدير البيانات',
  'export.selectFields': 'اختر الحقول للتصدير',
  'export.settings': 'إعدادات التصدير',
  'export.format': 'التنسيق',
  'export.filterStatus': 'تصفية حسب الحالة',
  'export.allClients': 'الكل',
  'export.activeOnly': 'نشطين',
  'export.archivedOnly': 'مؤرشفين',
  'export.clientsToExport': '{count} عملاء سيتم تصديرهم',
  'export.fieldsSelected': '{count} حقول محددة',
  'export.exportButton': 'تصدير {count} عملاء',
  'export.additionalExports': 'تصدير إضافي',
  'export.exportFilings': 'تصدير التقديمات',
  'export.exportTasks': 'تصدير المهام',
  'export.exported': 'تم تصدير {count} عملاء',
  'export.filingsExported': 'تم تصدير التقديمات',
  'export.tasksExported': 'تم تصدير المهام',
  'export.csvExcel': 'CSV (Excel)',
  'export.json': 'JSON',
  'export.field.name': 'اسم العميل',
  'export.field.taxId': 'رقم المشتغل',
  'export.field.caseNum': 'رقم الملف',
  'export.field.email': 'البريد الإلكتروني',
  'export.field.phone': 'الهاتف',
  'export.field.mobile': 'الجوال',
  'export.field.address': 'العنوان',
  'export.field.city': 'المدينة',
  'export.field.type': 'نوع الكيان',
  'export.field.clientType': 'التصنيف الضريبي',
  'export.field.monthlyFee': 'أتعاب شهرية',
  'export.field.status': 'الحالة',
  'export.field.billingDay': 'يوم الفوترة',
  ...
  'docs.selectClient': 'اختر عميل',
  'docs.selectFolder': 'اختر مجلد',
  'docs.sensitivity': 'الحساسية',
