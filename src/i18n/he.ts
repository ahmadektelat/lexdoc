...
export const he: Record<string, string> = {
  ...
  'backup.piiWarningTitle': 'אזהרת מידע רגיש',
  'backup.piiWarningDesc': 'קובץ הגיבוי מכיל מידע רגיש כגון מספרי זהות, נתונים פיננסיים ומידע אישי. יש לשמור את הקובץ במקום מאובטח.',
  'backup.fileTooLarge': 'הקובץ גדול מדי. הגודל המרבי הוא {size}.',
  ...
  'import.invalidEmail': 'כתובת מייל לא תקינה',
  'import.invalidPhone': 'מספר טלפון לא תקין',
  'import.invalidTaxId': 'מספר עוסק לא תקין',
  'import.invalidFee': 'סכום שכ"ט לא תקין',
